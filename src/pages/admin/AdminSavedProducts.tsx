...
const AdminSavedProducts: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <ProfileHeader 
        ...
        description="Products you've bookmarked for later reference" 
      ...
      {isLoading ? (
        ...
        <div className="text-center py-10 space-y-4 border rounded-lg p-8">
          ...
          <p className="text-muted-foreground">
            When reviewing products, click the bookmark icon to save them here for later reference
          </p>
...
export default AdminSavedProducts;
